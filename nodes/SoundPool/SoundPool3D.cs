...
namespace HS.Sound
{
    ...
    /// </summary>
    [Tool]
    public partial class SoundPool3D : Node3D
    {
        // EXPORTS //////////////////////////////////////////
        /// <summary>
        ...
        private Array<AudioStreamPlayer3D> m_audioPlayers;
        ...
        public override void _Ready()
        {
            ...
            {
                if(children[i] is AudioStreamPlayer3D player)
                {
                ...
                {
                    #if DEBUG
                    GD.Print("//////// SOUND POOL 3D WARNING ////////");
